...
porosity0 = 0.5 # initial porosity in each cell
...
algae = 5 # select from discrete "levels" of surface glacier algal loading between 0 (clean) and 3 (high concentration)
...
cellG = 0.5 # growth rate
cellD = 0.5 # death rate
...
# CALCULATE FLOWS
Out,porosity = TransientFlowModel(x, y, z, t, glacier, epsilon, constrain_head_to_WC, rainfall0, MELT_CALCS, moulin_location)
